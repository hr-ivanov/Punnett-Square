...
namespace PunnettSquareGenerator
{
    internal class Hybrids
    {
                ...
                for (int j = 1; j < dg.ColumnCount; j++)
                {
                    ...
                    switch (relationship)
                    {
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            variant = DominantEpisthase(variant, adData);
                            break;
                        case 6:
                            variant = RecessiveEpisthase(variant, adData);
                            break;
                        case 7:
                            variant = PolygenicQuantitative(variant, adData);
                            break;
                        case 8:
                            variant = PolygenicNonQuantitative(variant, adData);
                            break;
                        default:
                            break;
                    }
        ...
        private string DominantEpisthase(string variant, string adData)
        {
            return variant;
        }
        private string RecessiveEpisthase(string variant, string adData)
        {
            return variant;
        }
        private string PolygenicQuantitative(string variant, string adData)
        {
            return variant;
        }
        private string PolygenicNonQuantitative(string variant, string adData)
        {
            return variant;
        }
