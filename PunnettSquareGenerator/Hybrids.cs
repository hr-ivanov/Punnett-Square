...
namespace PunnettSquareGenerator
{
    internal class Hybrids
    {
        ...
        {
            /*Определяне на броя на гаметите: Ако индивидът е хетерозиготен по даден белег
            (т.е. има и главна, и малка буква (напр. Аа)),
        ...
        public string[,] GenerateData()
        {
            ...
            /*Намиране на генотиповете на децата.
            Всеки от тях се състои от една гамета на единия родител и една гамета на другия родител,
			...
			След свършване на цикъла twoAlleles съдържа вече напълно сортиран целия пореден генотип на детето, който се записва отново в a[j,i],
            а twoAlleles се нулира, за да се започне записването на следващия генотип на дете*/
